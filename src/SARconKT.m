function [c,ceq] = SARconKT(xxx,TR,RFA,dt)
...
c = RFA*RFA*max(abs(lSAR))*1e12/5; %% Attention, for KT, need to divide nspts, as average the amplitude by time means nspts/(nspts*nspts) = 1/nspts
if c<10
